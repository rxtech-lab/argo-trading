...
func (suite *BacktestStateTestSuite) TestUpdate_LongPosition() {
		...
		},
		{
			...
			expectedTrades: []types.Trade{
				...
				},
				{
					...
					CumulativePnL: (110*100 - 1) - (100*100 + 1),
				},
			},
			expectedPosition: ExpectPosition{
				Position: types.Position{
		...
		},
		{
			...
			expectedTrades: []types.Trade{
				...
				},
				{
					...
					PnL: 998,
					// Cumulative: avg entry = (27000+3)/300 = 90.01
					// PnL = (110*100 - 1) - (90.01*100) = 1998
					CumulativePnL: 1998,
				},
				{
					Order: types.Order{
					...
					// PnL = (120*100 - 1) - (90*100 + 1) = 2998
					PnL: 2998,
					// Cumulative: avg entry = 90.01
					// PnL = (120*100 - 1) - (90.01*100) = 2998
					CumulativePnL: 2998,
				},
				{
					Order: types.Order{
					...
					// PnL = (130*100 - 1) - (80*100 + 1) = 4998
					PnL: 4998,
					// Cumulative: avg entry = 90.01
					// PnL = (130*100 - 1) - (90.01*100) = 3998
					CumulativePnL: 3998,
				},
			},
			expectedPosition: ExpectPosition{
	...
	for _, tc := range tests {
		suite.Run(tc.name, func() {
			...
			suite.Assert().Equal(tc.expectedPosition.TotalLongPositionQuantity, position.TotalLongPositionQuantity, "Position quantity mismatch")
